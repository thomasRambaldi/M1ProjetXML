...
public class SampleCreateDom {
	...
	public static void main(String[] args) throws Exception {
		...
		doc =  factory.newDocumentBuilder().parse("ue.xml");
	...
	public static void xsl() throws TransformerException{
		...
		analyseur.transform(new StreamSource("ue.xml"), xml);
		DOMSource xmlSrc = new DOMSource(xml.getNode());
		analyseur.transform(xmlSrc, new StreamResult("ue2.xml") );

		// Un "transformer" processeur XSL
		Transformer xslt = factory.newTransformer( new StreamSource("ue.xsl") );
